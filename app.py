...
st.markdown("""
<style>
    /* Remove scrollbars and adjust container to fit screen */
    html, body {
    ...
    /* Adjust option menu height */
    .nav-link {
        padding: 10px 8px !important;
    }
    
    /* Make sure plotly charts fit properly */
    .js-plotly-plot {
...
with col1:
    ...
    <div class="logo-container">
        <img src="aig_logo.png" alt="AIG Logo" style="width: 80px; height: 80px; object-fit: contain;">
    </div>
    """, unsafe_allow_html=True)
...
with col3:
    ...
    st.markdown("""
    <div class="logo-container">
        <img src="bps_logo.png" alt="BPS Logo" style="width: 100px; height: 80px; object-fit: contain;">
    </div>
    """, unsafe_allow_html=True)
...
selected_main_tab = option_menu(
    ...
    styles={
        "container": {"padding": "0px !important", "background-color": "white", "margin-bottom": "0.5rem", "flex-wrap": "nowrap"}, # Ensure it stays horizontal
        "nav-link": {
            "font-size": "12px", 
            "font-weight": "bold",
            "color": "#333",
...
if st.session_state.main_tab == 'Neraca Nasional':
    ...
    try:
        ...
        fig.update_layout(height=300, plot_bgcolor='white', margin=dict(l=40, r=40, t=40, b=40))
    ...
    fig_sample.update_layout(height=300, plot_bgcolor='white', margin=dict(l=40, r=40, t=40, b=40))
